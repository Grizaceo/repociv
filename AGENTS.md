...
- 42 tools cubriendo 15 dominios del bridge con tools MCP (agents, external agents, commands, approvals, pending, context, GPU, providers, tasks, directives, events, WebSocket, wonders, graph-relations, foreign-relations)
