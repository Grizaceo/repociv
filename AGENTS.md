...
- 41 tools cubriendo 14 dominios del bridge con tools MCP (agents, commands, approvals, pending, context, GPU, providers, tasks, directives, events, WebSocket, wonders, graph-relations, foreign-relations)
