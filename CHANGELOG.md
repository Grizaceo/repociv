...
- **MCP server expansion (+11 tools)** — 11 tools nuevas: `wonders_list`, `wonders_get`, `wonder_health`, `graph_relations_list`, `graph_relations_evidence`, `graph_relations_stats`, `foreign_repo_profile`, `foreign_reports_list`, `foreign_report_get`, `ws_info`. Total: 41 tools, 14 dominios. Commits `cc82088`, `5f6393d`.
