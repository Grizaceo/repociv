...
from .routes import registry as _registry  # noqa: E402
...
class BridgeHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:
        ...
        if path in _registry.GET_EXACT:
            status, body = _registry.GET_EXACT[path](ctx)
    ...
    def do_POST(self) -> None:
        ...
        # ── Simple exact-match POST routes (table: routes/registry.py) ─────────
        if path in _registry.POST_EXACT:
