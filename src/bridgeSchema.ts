...
const UnitType = v.picklist(['hero', 'worker', 'scout', 'army', 'caravan', 'lexo']);
...
const Schemas = [
  v.object({
    ...
    unit: v.string(), civ: v.string(), hex: Hex,
    mission: v.optional(v.string()),
    unitType: v.optional(UnitType),
  }),
  v.object({
    type: v.literal('unit_move'),
    unit: v.string(), from: Hex, to: Hex,
    mission: v.optional(v.string()),
  }),
  v.object({
    type: v.literal('unit_work'),
    unit: v.string(), hex: Hex, progress: v.number(),
    mission: v.optional(v.string()),
  }),
  v.object({
    type: v.literal('unit_state'),
    unit: v.string(), state: UnitState,
  }),
  v.object({
    type: v.literal('building_start'),
    city: v.string(), building: v.string(), durationSeconds: v.number(),
    buildingType: v.optional(BuildingKind),
    pid: v.optional(v.number()), cmd: v.optional(v.string()),
    missionId: v.optional(v.string()),
  }),
  v.object({
    type: v.literal('building_progress'),
    city: v.string(), building: v.string(), progress: v.number(),
  }),
  v.object({
    type: v.literal('building_complete'),
    city: v.string(), building: v.string(),
    missionId: v.optional(v.string()),
  }),
  v.object({
  ...
  v.object({
    ...
    name: v.string(), hex: Hex,
  }),
  v.object({
    type: v.literal('resource_update'),
    resource: Resource, delta: v.number(),
  }),
  v.object({
  ...
  v.object({
    ...
    missionId: v.string(), unit: v.string(), questName: v.string(),
  }),
  v.object({
